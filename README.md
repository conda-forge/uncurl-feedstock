...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/uncurl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10124&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/uncurl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `uncurl` can be installed with:

```
conda install uncurl
```

It is possible to list all of the versions of `uncurl` available on your platform with:
